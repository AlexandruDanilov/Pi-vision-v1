...
def angle_to_pulse_width(angle):
    return SERVO_MIN_PULSE_WIDTH + int((angle - SERVO_MIN_ANGLE) / (SERVO_MAX_ANGLE_X - SERVO_MIN_ANGLE) * (SERVO_MAX_PULSE_WIDTH - SERVO_MIN_PULSE_WIDTH))
...
if __name__ == "__main__":
    while True:
        ...
        target_angle_x = max(min(SERVO_MAX_ANGLE_X, target_angle_x + delta_angle_x), SERVO_MIN_ANGLE)
